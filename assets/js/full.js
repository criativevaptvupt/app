...
<div class="full">
    <div class="container">
        <div class="content-text">
            <h3>Criative</h3>
            <h1>Vapt Vupt</h1>
            <p>Leve, funcional, criativo, inovador e conceitual</p>
        </div>
        <div class="content-footer">
            <p>Agencia de criação e </br> gestão de novos negócios.</p>

            <a class="btn primary" href="#service">
                veja mais
            </a>
        </div>
        ...
        <div class="content-services">
                <div class="col">
                    <div class="card-active">
                        <h6>Sites</h6>
                        <p>Desenvolvemos seu site profissional, customizado e inteligente para 
                            converter seus visitantes em vendas.
                        </p>
                        <a href="landingpage.html">Mais</a>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card">
                        <h6>Loja Virtual</h6>
                        <p>Construimos sua loja virtual personalizada com meios de pagamento e 
                            pronta para impulsionar suas vendas.</p>
                        <a href="loja.html">Mais</a>
                    </div>
                </div>
